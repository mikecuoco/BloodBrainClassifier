...
# tpm - A gene expression matrix for AD, N, and C patients
# donors - Info about each individual in the study
# genes - Info about each gene in tpm
...
# the values of X_train, X_test, y_train, y_test
...
# and y_test globally!
def split(dat=None, test_size=0.33, random_state=42):
